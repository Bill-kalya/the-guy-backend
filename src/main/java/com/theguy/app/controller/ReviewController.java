...
public class ReviewController {
    ...
    public ResponseEntity<ApiResponse<Page<Review>>> getProviderReviews(
            @PathVariable UUID providerId,
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "20") int size) {
        
        Page<Review> reviews = reviewRepository.findByProviderId(providerId, PageRequest.of(page, size));
